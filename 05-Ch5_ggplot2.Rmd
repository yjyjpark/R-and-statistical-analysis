...
```{r, , ggplot-ex-2-8, echo=FALSE, fig.align='center', fig.width=7.5}
mpg %>% 
...
```{r, , ggplot-ex-2-9, echo=FALSE, fig.align='center', fig.width=7.5}
mpg_avg %>% 
...
```{r, ggplot-ex-2-10, echo=FALSE, fig.align='center', fig.height=4.3}
mpg_avg %>% 
  ggplot(aes(x = displ, y = avg_mpg)) +
  geom_point() +
