...
1)   `cars_93`에 대해서는 `cyl`의 그룹별 두 연속형 변수의 산점도를 각각 작성한다.
...
2)   `cars_99`에 대해서는 두 연속형 변수의 산점도 점 모양과 색을 `cyl`의 값에 다르게 작성
...
```{r ch4-ex5-1, fig.cap="대한민국 주요 수출품목 및 수출액 막대그래프", fig.width=7, fig.height=5}
export |> 
