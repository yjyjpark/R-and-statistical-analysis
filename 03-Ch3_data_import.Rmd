...
![data2_1.txt](그림/data2_1.png "data2_1.txt"){#data2-1}
...
그림 \@ref(fig:wiki)은 [Wikipedia](https://en.wikipedia.org/wiki)에서 "World population"을 검색하면 열리는 웹 페이지에 있는 "10 most densely populated countries"라는 제목의 HTML 테이블을 보여주고 있다. 검색은 2022년 2월 9일에 실시된 것을 바탕으로 하고 있으며, 차후에 HTML 테이블의 배치가 변경되면 아래 예제 프로그램도 적절히 변경해야 할 것이다.
